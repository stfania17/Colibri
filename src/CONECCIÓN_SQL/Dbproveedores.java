...
public class Dbproveedores extends proveedores{
    SQConnect connecta =  new SQConnect();
    public Dbproveedores(String cedula, String apellido, String nombre, String telefono, String direccion, Date fechanacimiento, String codigo, String numero_cuenta) {
