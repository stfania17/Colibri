...
import MODELO.encabezado_factura;
...
public class Dbcabeza_factura extends encabezado_factura {
    SQConnect connecta =  new SQConnect();
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    public Dbcabeza_factura(String codigo, String cod_cliente, Date fecha) {
        super(codigo, cod_cliente, fecha);
    }
    public Dbcabeza_factura(){
    }
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    public List<encabezado_factura> mostrarDatos() {
        ...
        try {
            ...
            Logger.getLogger(Dbcabeza_factura.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ////////////////////////////////////////////////////////////////////////////
