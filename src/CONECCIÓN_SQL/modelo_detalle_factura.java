...
public class modelo_detalle_factura extends detalle_factura {
    ...
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    public modelo_detalle_factura(String codigo, String cod_encabezado, String cod_producto, int cantidad, double precio_final) {
        super(codigo, cod_encabezado, cod_producto, cantidad, precio_final);
    }
    public modelo_detalle_factura(){       
    }
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    public List<detalle_factura> mostrarDatos() {
        ...
        try {
            ...
            Logger.getLogger(modelo_detalle_factura.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ////////////////////////////////////////////////////////////////////////////
    public List<detalle_factura> mostrarDatos(String ida) {
        String sql = "select * from detalle_factura where ";
            ...
            sql += " OR upper(cod_encabezado) like Upper('%" + ida + "%') ";
            sql += " OR upper(cod_producto) like Upper('%" + ida + "%') ";
